...
index_page = html.Div([
    ...
    html.Div(
    html.Button('Verify', id='verify', n_clicks=0, style={'border-width':'1px','font-size':'14px'}),
    style={'margin-left':'50%','padding-top':'30px','border-color':'rgb(0,123,255)'}),
    html.Div([dcc.Input(id='submitmode', value = 0)
        ], style={'display':'none'})
    ])

incorrect_page = html.Div([
    html.Div(
    dcc.Input(id="user", type="text", placeholder="Enter Username",className="inputbox1",
    style={'margin-left':'35%','width':'450px','height':'45px','padding':'10px','margin-top':'60px',
    'font-size':'16px','border-width':'3px','border-color':'rgb(0,123,255)'
    ...
    html.Div(
    html.Button('Verify', id='verify', n_clicks=0, style={'border-width':'1px','font-size':'14px'}),
    style={'margin-left':'50%','padding-top':'30px'}),
    html.Th(['Incorrect Username and Password'],style={'margin-left':'50%','textAlign':'Center','color':'rgb(0,123,255)'}),
    ])
...
next_page = html.Div([
            html.Div(dcc.Link('Log out', href='/',style={'color':'#FFFFFF','font-family': 'serif', 'font-weight': 'bold', "text-decoration": "none",'font-size':'20px'}),style={'padding-left':'80%','padding-top':'10px','background-color':'rgb(0,123,255)'}),
            html.Div([
                 html.Div([
